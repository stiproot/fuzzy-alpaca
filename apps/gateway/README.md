...
The broker **gateway** — component one of the fuzzy-alpaca system (see
[../../docs/system-architecture.md](../../docs/system-architecture.md)). An HTTP trading API
wrapping [Alpaca](https://alpaca.markets): typed, idempotent, safe access to equities + crypto for
the orchestrator. Built with Effect-TS in a hexagonal layout. As-built design:

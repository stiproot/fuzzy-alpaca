# Experiment 001 — Do any naive TA configs clear the gate on crypto?

| | |
|---|---|
| **Date** | 2026-07-08 |
| **Status** | refuted |
| **One-liner** | 72 configs; 2 short-window passes evaporated on deep data — naive price-only TA has no edge on crypto majors |
| **Next** | [002 — beyond-price signals](002-beyond-price-signals-crypto.md) |
